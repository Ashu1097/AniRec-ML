...
def item_genres():
    ...
    genre_pool = ["Action", "Drama", "Comedy", "Sci-Fi", "Fantasy",
                  "Romance", "Horror", "Psychological", "Thriller", "Slice of Life"]
    rng = np.random.default_rng(42)
    return {
        i: list(rng.choice(genre_pool, size=rng.integers(1, 4), replace=False))
        for i in range(100)
    }
